      ...
      <div className="w-full sm:max-w-[480px] md:max-w-[560px] sm:mx-6 bg-white dark:bg-[#1f2128] sm:rounded-xl rounded-t-2xl shadow-[0px_8.5px_13.75px_0px_#171a1f38,_0px_0px_2px_0px_#171a1f14] overflow-hidden">
        ...
        <div className="bg-[#f3f4f6]/20 dark:bg-white/5 px-5 py-4 border-b border-[#dee1e6] dark:border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#636AE8]/10 rounded-full flex items-center justify-center shrink-0">
              <img className="w-6 h-6 dark:invert" src={isEdit ? '/assets/icon-pen.svg' : '/assets/icon-plus.svg'} alt="item" />
            </div>
            <div>
              <p className="font-[Archivo] text-lg font-semibold text-[#171a1f] dark:text-[#f3f4f6] tracking-tight">
        ...
        <form onSubmit={handleSave}>
          ...
          <div className="p-5 flex flex-col gap-4">
            ...
            <div>
              <label className="block font-[Archivo] text-sm font-semibold text-[#171a1f] dark:text-[#e5e7eb] mb-2">Item Name</label>
              <input
                type="text"
                value={itemName}
                onChange={e => setItemName(e.target.value)}
                className="w-full h-11 px-3 border border-[#dee1e6] dark:border-white/10 bg-white dark:bg-white/5 rounded-md text-sm font-[Archivo] text-[#171a1f] dark:text-[#e5e7eb] outline-none focus:border-[#636AE8]"
                placeholder="e.g. Wooden Toothpicks"
              />
            </div>

            <div>
              <label className="block font-[Archivo] text-sm font-semibold text-[#171a1f] dark:text-[#e5e7eb] mb-2">Item Type</label>
              <select
                value={itemType}
                onChange={e => setItemType(e.target.value)}
                className="w-full h-11 px-3 border border-[#dee1e6] dark:border-white/10 rounded-md text-sm font-[Archivo] text-[#171a1f] dark:text-[#e5e7eb] outline-none focus:border-[#636AE8] bg-white dark:bg-[#1f2128]"
              >
            ...
            <div>
              <label className="block font-[Archivo] text-sm font-semibold text-[#171a1f] dark:text-[#e5e7eb] mb-2">Measurement Unit</label>
              <select
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block font-[Archivo] text-sm font-semibold text-[#171a1f] dark:text-[#e5e7eb] mb-2">Starting Stock</label>
                <input
                  type="number"
                  value={startingStock}
              ...
              <div>
                <label className="block font-[Archivo] text-sm font-semibold text-[#171a1f] dark:text-[#e5e7eb] mb-2">Low Stock Threshold</label>
                <input
                  type="number"
